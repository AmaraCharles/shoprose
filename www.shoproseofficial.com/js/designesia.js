 /* --------------------------------------------------
  * © Copyright 2023 - Shoperoseofficial.com
  * --------------------------------------------------*/
(function($) {
	'use strict';
    ...
    if($("body").hasClass("switch-scheme")){
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme')){
            window.location.href = 'https://Shoperoseofficial.io/index.html';
        }else{
            window.location.href = 'https://Shoperoseofficial.io/02_dark-index.html';
        }
     });
